    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('agent', 'مشاور حقوقی'), ('User', 'کاربر')], max_length=20, verbose_name='نقش کاربر')),
                ...
                ('job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='job.job')),
